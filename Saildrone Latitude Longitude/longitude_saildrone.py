# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 09:29:25 2022
...
ds1['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1005 2017', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1005_2017_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds2['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1006 2017', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1006_2017_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds3['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1005 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1005_2018_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds4['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1006 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1006_2018_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds5['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1029 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1029_2018_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds6['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1030 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1030_2018_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds7['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1066 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1066_2019_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds8['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1067 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1067_2019_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds9['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1068 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1068_2019_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds10['longitude'].plot(color='blue')

plt.ylabel('Longitude')
plt.xlabel('Time')
plt.title('Longitude - SD 1069 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronelongitude_1069_2019_nonadcp.png', transparent = False, bbox_inches = 'tight', dpi=200)