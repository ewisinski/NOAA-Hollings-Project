# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 14:30:03 2022
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Meridional Current Depth - TAO ADCP 0, 110W Sep 2017 - May 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_vadcp_110W_SD1.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Meridional Current Depth - TAO ADCP 0, 140W Sep 2017 - May 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_vadcp_140W_SD1.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Meridional Current Depth - TAO ADCP 0, 170W Sep 2017 - May 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_vadcp_170W_SD1.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Meridional Current Depth - TAO ADCP 0, 165E Sep 2017 - May 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_vadcp_165E_SD1.png', transparent = False, bbox_inches = 'tight', dpi=200)