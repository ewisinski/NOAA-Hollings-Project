# -*- coding: utf-8 -*-
"""
Created on Tue Jun  7 12:29:59 2022
...
#prints info about dataset and specific variables of interest
print(ds1)
print(ds1['UWND_MEAN'])
print(ds1['VWND_MEAN'])

#swaps axes to line them up properly
ds1 = ds1.swap_dims({'row':'time'})
#.dropna() handles missing values by dropping them from the dataset
ds1['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1005 2017', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1005_2017.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds2['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1006 2017', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1006_2017.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds3['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1005 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1005_2018.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds4['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1006 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1006_2018.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds5['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1029 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1029_2018.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds6['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1030 2018', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1030_2018.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds7['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1066 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1066_2019.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds8['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1067 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1067_2019.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds9['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1068 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1068_2019.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
ds10['UWND_MEAN'].dropna(dim='time').plot(color='blue')

plt.ylabel('Wind Velocity (m/s)')
plt.ylim(-20, 15)
plt.xlabel('Time')
plt.title('Zonal Wind - SD 1069 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/saildronezonalwind_1069_2019.png', transparent = False, bbox_inches = 'tight', dpi=200)