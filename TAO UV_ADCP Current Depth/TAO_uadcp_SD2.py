# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 14:41:19 2022
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Zonal Current Depth - TAO ADCP 0, 110W Oct 2018 - Feb 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_uadcp_110W_SD2.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Zonal Current Depth - TAO ADCP 0, 140W Oct 2018 - Feb 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_uadcp_140W_SD2.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Zonal Current Depth - TAO ADCP 0, 170W Oct 2018 - Feb 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_uadcp_170W_SD2.png', transparent = False, bbox_inches = 'tight', dpi=200)
...
plt.xlabel('Time')
plt.ylim([325,0])
plt.title('Zonal Current Depth - TAO ADCP 0, 165E Oct 2018 - Feb 2019', fontweight='bold')
fig1 = plt.gcf()
plt.show()
plt.draw()
fig1.savefig('C:/Users/emily/Downloads/TAO_uadcp_165E_SD2.png', transparent = False, bbox_inches = 'tight', dpi=200)